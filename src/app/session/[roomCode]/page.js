...
export default function SessionRoom() {
    ...
    useEffect(() => {
        ...
        socketRef.current.on('session-state', data => {
            ...
            setParticipant(data.current || null);
        ...
        socketRef.current.on('participant-joined', data => {
            ...
            console.log(
                'Participant joined, participants updated:',
        ...
        socketRef.current.on('participant-edit-changed', data => {
            console.log('Participant edit permission changed:', data);
            console.log('Participant edit permission changed partici:', participant);
            const { participantId, canEdit: newCanEdit, participants: updatedParticipants, targetSocketId } = data;
        ...
        socketRef.current.on('participant-edit-changed-for-all', data => {
            const { participantId, canEdit: newCanEdit, participants: updatedParticipants, targetSocketId } = data;
    ...
    const handleToggleParticipantEdit = (participantId, currentCanEdit) => {
        console.log('Toggling edit for participant:', participantId, 'currentCanEdit:', currentCanEdit);
        if (isHost && socketRef.current) {
            console.log('Toggling edit for participant 2:', participantId, 'currentCanEdit:', currentCanEdit);
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50 dark:from-gray-900 dark:to-gray-800">
            ...
            <div className="flex flex-col lg:flex-row h-[calc(100vh-100px)] lg:h-[calc(100vh-73px)]">
                ...
                <div
                    className={`w-full lg:w-96 bg-white/90 backdrop-blur-sm dark:bg-gray-800/90 border-l border-gray-200/50 dark:border-gray-700/50 flex flex-col ${
                        showMobilePanel
